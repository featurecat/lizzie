...
public class RightClickMenu extends JPopupMenu {
	...
	public RightClickMenu() {
		...
		addSuggestionAsBranch= new JMenuItem(resourceBundle.getString("RightClickMenu.addSuggestionAsBranch"));
		...
		addSuggestionAsBranch.addActionListener(new ActionListener() {
			@Override
		...
		addAllow.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				addAllow();
			}
		...
		keepingAvoid.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				keepingAvoid();
			}
		...
		clearAvoidAllow.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				clearAvoidAllow();
			}
	...
	private void allow() {
		if (Lizzie.board.setAllowCoords(mousex, mousey)) {
			...
			Lizzie.board.isAvoding=false;
			Lizzie.leelaz.analyzeAvoid("allow", Lizzie.board.getHistory().isBlacksTurn()? "b" : "w", Lizzie.board.allowCoords, 1);
	...
	public void avoid() {
		Lizzie.board.setAvoidCoords(mousex, mousey);
			...
			Lizzie.board.isAllowing= false;
			Lizzie.leelaz.analyzeAvoid("avoid", Lizzie.board.getHistory().isBlacksTurn()? "b" : "w", Lizzie.board.avoidCoords, Lizzie.config
	                .config

...
public final class SwingUtils {
   ...
   *
   * <p>Invoking this method with a class parameter of JComponent.class will return all nested
   * components.
   *
   * <p>This method invokes getDescendantsOfType(clazz, container, true)
   *
   ...
   *
   * <p>This method invokes getDescendantOfType(clazz, container, property, value, true)
   *
   * @param clazz the class of component whose instance is to be found.
   * @param container the container at which to begin the search
   * @param property the className of the bound property, exactly as expressed in the accessor e.g.
   *     "Text" for getText(), "Value" for getValue().
   ...
   *     "Text" for getText(), "Value" for getValue().
   * @param value the value of the bound property
   * @param nested true to list components nested within another component which is also an instance
   *     of <code>clazz</code>, false otherwise
   * @return the component, or null if no such component exists in the container
   * @throws java.lang.IllegalArgumentException if the bound property does not exist for the class
   *     or cannot be accessed
   */
  public static <T extends JComponent> T getDescendantOfType(
      Class<T> clazz, Container container, String property, Object value, boolean nested)
      throws IllegalArgumentException {
  ...
  /**
   * Convenience method for searching below <code>container</code> in the component hierarchy and
   * return nested components of class <code>clazz</code> it finds. Returns an empty list if no such
   * components exist in the container.
   *
   * <p>This method invokes getDescendantsOfClass(clazz, container, true)
   *
   ...
   * depth first manner and returns the first found component of class <code>clazz</code> having the
   * bound property value.
   *
   * <p>Returns {@code null} if such component cannot be found.
   *
   * <p>This method invokes getDescendantOfClass(clazz, container, property, value, true)
   *
   * @param clazz the class of component to be found.
   * @param container the container at which to begin the search
   * @param property the className of the bound property, exactly as expressed in the accessor e.g.
   *     "Text" for getText(), "Value" for getValue(). This parameter is case sensitive.
   * @param value the value of the bound property
  ...
  private static <T extends JComponent> T getComponentFromList(
      Class<T> clazz, List<T> list, String property, Object value) throws IllegalArgumentException {
    T retVal = null;
    Method method = null;
    try {
      ...
      try {
        ...
        throw new IllegalArgumentException(
            "Property " + property + " not found in class " + clazz.getName());
      }
    }
    try {
      for (T t : list) {
      ...
      throw new IllegalArgumentException(
          "Error accessing property " + property + " in class " + clazz.getName());
   ...
   *
   * <p>Implementation note: The returned value is a HashMap and the values are of type ArrayList.
  ...
  /**
   * Convenience method for obtaining most non-null human readable properties of a JComponent. Array
   * properties are not included.
   *
   * <p>Implementation note: The returned value is a HashMap. This is subject to change, so callers
